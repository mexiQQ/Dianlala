...
- (BOOL)application:(UIApplication *)application
  ...
  if (![[NSUserDefaults standardUserDefaults] objectForKey:@"first_launch"]) {
    WelcomeViewController *welcome =
        [mainStoryboard instantiateViewControllerWithIdentifier:@"welcome"];
    ...
    if ([[NSUserDefaults standardUserDefaults] objectForKey:@"isBind"]) {
      QRViewController *qreader =
          [mainStoryboard instantiateViewControllerWithIdentifier:@"qreader"];
      window.rootViewController = qreader;
    } else {
      BindViewController *bind =
